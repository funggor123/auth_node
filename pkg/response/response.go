...
type CreatePlayerResponse struct {
	...
	DayPhone     string `json:"dayPhone" binding:"required"`
	EveningPhone string `json:"eveningPhone" binding:"required"`
	CellPhone    string `json:"cellPhone" binding:"required"`

	BirthDate     string `json:"birthdate" binding:"required"`
	PlayerClassID string `json:"playerClassId" binding:"required"`
	CountryID     string `json:"countryId" binding:"required"`

	Currency  string `json:"currency" binding:"required"`
	WallentID string `json:"wallentId" binding:"required"`
